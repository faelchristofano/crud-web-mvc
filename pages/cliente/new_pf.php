                                ...
                                <form id=form name=form> 
                                    <div class="row">   
                                        ...
                                        <div class="form-group col-lg-3" >
                                            ...
                                            <input class="form-control" placeholder="Informe a data de nascimento" name="datanasc" id="datanasc">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">    
                                        <div id="pessoa-fisica">
                                            <div class="form-group col-lg-6" id="form-cpf" >
                                                ...
                                                <input class="form-control" placeholder="Informe o CPF" name="cpf" id="cpf">
                                            </div>                                          
                                            <div class="form-group col-lg-6">
                                                <label>RG</label>
                                                <input class="form-control" placeholder="Informe o RG" name="rg">
                                            </div>
                                        </div>
                                    </div>
